...
const LOGIN_AUDIT_LOG_ACTION_TYPE_COLOR_MAP: Record<LoginAuditLog_ActionType, string> = {
...
const LOGIN_AUDIT_LOG_RISK_LEVEL_COLOR_MAP: Record<LoginAuditLog_RiskLevel, string> = {
