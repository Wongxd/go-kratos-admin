...
export const usePermissionAuditLogStore = defineStore("permission-audit-log", () => {
  const service = createPermissionAuditLogServiceClient(requestClientRequestHandler);
