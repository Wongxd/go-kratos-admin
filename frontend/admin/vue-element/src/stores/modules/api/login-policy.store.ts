...
export const useLoginPolicyStore = defineStore("login-policy", () => {
   ...
   * 更新登录策略
   */
  async function updateLoginPolicy(id: number, values: Record<string, any> = {}) {
...
export function loginPolicyMethodToColor(methodName: LoginPolicy_Method) {
  return (
    LOGIN_POLICY_METHOD_COLOR_MAP[methodName as keyof typeof LOGIN_POLICY_METHOD_COLOR_MAP] ||
