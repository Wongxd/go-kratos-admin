...
import {type authenticationservicev1_LoginRequest, getMe, login, logout, refreshToken} from "@/api";
                ...
                try {
                    ...
                    if (response.refresh_token) {
                        set({
                            ...
                            refreshTokenExpireAt: now + (response.refresh_expires_in || DEFAULT_REFRESH_EXPIRES_IN) * 1000,
                        });
                    }
