...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	operationAuditLogService := service.NewOperationAuditLogService(context, operationAuditLogRepo, apiRepo)
	...
	httpServer, err := server.NewRestServer(context, authenticator, authorizer, operationAuditLogRepo, loginAuditLogRepo, authenticationService, userService, menuService, routerService, orgUnitService, roleService, positionService, dictService, loginAuditLogService, operationAuditLogService, ossService, uEditorService, fileService, tenantService, taskService, internalMessageService, internalMessageCategoryService, internalMessageRecipientService, loginPolicyService, userProfileService, apiService, permissionService, permissionGroupService, permissionAuditLogService, policyEvaluationLogService)
	if err != nil {
		cleanup2()
		cleanup()
		return nil, nil, err
