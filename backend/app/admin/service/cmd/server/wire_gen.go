...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	authenticationService := service.NewAuthenticationService(context, userRepo, userCredentialRepo, roleRepo, tenantRepo, membershipRepo, orgUnitRepo, userTokenCacheRepo, authenticator)
	positionRepo := data.NewPositionRepo(context, entClient)
	userService := service.NewUserService(context, userRepo, roleRepo, userCredentialRepo, positionRepo, orgUnitRepo, tenantRepo, membershipRepo, membershipRoleRepo, membershipPositionRepo, membershipOrgUnitRepo)
