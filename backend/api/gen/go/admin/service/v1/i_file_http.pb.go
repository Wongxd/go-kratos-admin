...
import (
	...
	v11 "go-wind-admin/api/gen/go/file/service/v1"
...
func RegisterFileServiceHTTPServer(s *http.Server, srv FileServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/files", _FileService_List1_HTTP_Handler(srv))
	r.GET("/admin/v1/files/{id}", _FileService_Get1_HTTP_Handler(srv))
...
func _FileService_List1_HTTP_Handler(srv FileServiceHTTPServer) func(ctx http.Context) error {
...
func _FileService_Get1_HTTP_Handler(srv FileServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
