...
func RegisterLoginPolicyServiceHTTPServer(s *http.Server, srv LoginPolicyServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/login-policies", _LoginPolicyService_List6_HTTP_Handler(srv))
	r.GET("/admin/v1/login-policies/{id}", _LoginPolicyService_Get6_HTTP_Handler(srv))
...
func _LoginPolicyService_List6_HTTP_Handler(srv LoginPolicyServiceHTTPServer) func(ctx http.Context) error {
