...
func RegisterLoginAuditLogServiceHTTPServer(s *http.Server, srv LoginAuditLogServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/login-audit-logs", _LoginAuditLogService_List3_HTTP_Handler(srv))
	r.GET("/admin/v1/login-audit-logs/{id}", _LoginAuditLogService_Get3_HTTP_Handler(srv))
}

func _LoginAuditLogService_List3_HTTP_Handler(srv LoginAuditLogServiceHTTPServer) func(ctx http.Context) error {
...
func _LoginAuditLogService_Get3_HTTP_Handler(srv LoginAuditLogServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
