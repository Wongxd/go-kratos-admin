...
func (Menu_Type) EnumDescriptor() ([]byte, []int) {
	return file_admin_service_v1_i_menu_proto_rawDescGZIP(), []int{0, 0}
}
...
func (Menu_Status) EnumDescriptor() ([]byte, []int) {
	return file_admin_service_v1_i_menu_proto_rawDescGZIP(), []int{0, 1}
}
...
type Menu struct {
	...
	Status        *Menu_Status           `protobuf:"varint,2,opt,name=status,proto3,enum=admin.service.v1.Menu_Status,oneof" json:"status,omitempty"` // 菜单状态
	Type          *Menu_Type             `protobuf:"varint,3,opt,name=type,proto3,enum=admin.service.v1.Menu_Type,oneof" json:"type,omitempty"`       // 菜单类型
...
const file_admin_service_v1_i_menu_proto_rawDesc = "" +
	...
	"\x04type\x18\x03 \x01(\x0e2\x1b.admin.service.v1.Menu.TypeB\x12\xbaG\x0f\x92\x02\f菜单类型H\x02R\x04type\x88\x01\x01\x12.\n" +
	"\x04path\x18\n" +
...
var file_admin_service_v1_i_menu_proto_goTypes = []any{
	(Menu_Type)(0),                // 0: admin.service.v1.Menu.Type
	(Menu_Status)(0),              // 1: admin.service.v1.Menu.Status
...
var file_admin_service_v1_i_menu_proto_depIdxs = []int32{
	1,  // 0: admin.service.v1.Menu.status:type_name -> admin.service.v1.Menu.Status
