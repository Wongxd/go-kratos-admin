...
VALUES (1, NULL, 'FOLDER', 'Dashboard', '/', NULL, 'BasicLayout', 'ON', NOW(), '{"order":-1, "title":"page.dashboard.title", "icon":"lucide:layout-dashboard", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
       ...
       (52, 50, 'MENU', 'OperationAuditLog', 'operation', NULL, 'app/log/operation_audit_log/index.vue', 'ON', NOW(), '{"order":2, "title":"menu.log.operationAuditLog", "icon":"lucide:file-clock", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
...
INSERT INTO `sys_apis` (
    ...
    `description`, `module`, `module_description`, `operation`, `path`, `method`, `scope`
      ...
      (77, NOW(), NULL, NULL, NULL, NULL, NULL, '查询操作审计日志详情', 'OperationAuditLogService', '操作审计日志管理服务', 'OperationAuditLogService_Get', '/admin/v1/admin_operation_logs/{id}', 'GET', 'ADMIN'),
      ...
      (79, NOW(), NULL, NULL, NULL, NULL, NULL, '查询操作审计日志列表', 'OperationAuditLogService', '操作审计日志管理服务', 'OperationAuditLogService_List', '/admin/v1/admin_operation_logs', 'GET', 'ADMIN'),
