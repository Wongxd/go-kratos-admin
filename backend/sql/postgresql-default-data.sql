...
VALUES (1, null, 'CATALOG', 'Dashboard', '/dashboard', null, 'BasicLayout', 'ON', now(),
       ...
       (52, 50, 'MENU', 'OperationAuditLog', 'operation-audit-logs', null, 'app/log/operation_audit_log/index.vue', 'ON', now(),
        '{"order":2, "title":"menu.log.operationAuditLog", "icon":"lucide:file-clock", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
...
VALUES (1, now(), '分页查询字典类型列表', 'DictService', '数据字典管理服务', 'DictService_ListDictType',
       ...
       (13, now(), '查询操作审计日志详情', 'OperationAuditLogService', '操作审计日志管理服务',
        'OperationAuditLogService_Get', '/admin/v1/operation-audit-logs/{id}', 'GET', 'ADMIN'),
       ...
       (102, now(), '查询操作审计日志列表', 'OperationAuditLogService', '操作审计日志管理服务',
        'OperationAuditLogService_List', '/admin/v1/operation-audit-logs', 'GET', 'ADMIN'),
