...
VALUES (1, null, 'CATALOG', 'Dashboard', '/dashboard', null, 'BasicLayout', 'ON', now(),
       ...
       (51, 50, 'MENU', 'AdminLoginLog', 'admin-login-log', null, 'app/log/admin_login_log/index.vue', 'ON', now(),
        '{"order":1, "title":"menu.log.adminLoginLog", "icon":"lucide:user-lock", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
       (52, 50, 'MENU', 'AdminOperationLog', 'admin-operation-log', null, 'app/log/admin_operation_log/index.vue', 'ON', now(),
        '{"order":2, "title":"menu.log.adminOperationLog", "icon":"lucide:file-clock", "keepAlive":false, "hideInBreadcrumb":false, "hideInMenu":false, "hideInTab":false}'),
       ...
       (64, 60, 'MENU', 'AdminLoginRestrictionManagement', 'admin-login-restrictions', null,
...
VALUES (1, now(), '分页查询字典类型列表', 'DictService', '数据字典管理服务', 'DictService_ListDictType',
       ...
       (13, now(), '查询后台操作日志详情', 'AdminOperationLogService', '后台操作日志管理服务',
        'AdminOperationLogService_Get', '/admin/v1/admin_operation_logs/{id}', 'GET', 'ADMIN'),
       (14, now(), '查询后台登录日志详情', 'AdminLoginLogService', '后台登录日志管理服务', 'AdminLoginLogService_Get',
        '/admin/v1/admin_login_logs/{id}', 'GET', 'ADMIN'),
       ...
       (26, now(), 'UEditor API', 'UEditorService', 'UEditor后端服务', 'UEditorService_UEditorAPI', '/admin/v1/ueditor',
        'GET', 'ADMIN'),
       (27, now(), '删除后台登录限制', 'AdminLoginRestrictionService', '后台登录限制管理服务',
        'AdminLoginRestrictionService_Delete', '/admin/v1/login-restrictions/{id}', 'DELETE', 'ADMIN'),
       (28, now(), '查询后台登录限制详情', 'AdminLoginRestrictionService', '后台登录限制管理服务',
        'AdminLoginRestrictionService_Get', '/admin/v1/login-restrictions/{id}', 'GET', 'ADMIN'),
       (29, now(), '更新后台登录限制', 'AdminLoginRestrictionService', '后台登录限制管理服务',
        'AdminLoginRestrictionService_Update', '/admin/v1/login-restrictions/{id}', 'PUT', 'ADMIN'),
       ...
       (34, now(), '查询后台登录日志列表', 'AdminLoginLogService', '后台登录日志管理服务', 'AdminLoginLogService_List',
        '/admin/v1/admin_login_logs', 'GET', 'ADMIN'),
       ...
       (44, now(), '查询后台登录限制列表', 'AdminLoginRestrictionService', '后台登录限制管理服务',
        'AdminLoginRestrictionService_List', '/admin/v1/login-restrictions', 'GET', 'ADMIN'),
       (45, now(), '创建后台登录限制', 'AdminLoginRestrictionService', '后台登录限制管理服务',
        'AdminLoginRestrictionService_Create', '/admin/v1/login-restrictions', 'POST', 'ADMIN'),
       ...
       (102, now(), '查询后台操作日志列表', 'AdminOperationLogService', '后台操作日志管理服务',
        'AdminOperationLogService_List', '/admin/v1/admin_operation_logs', 'GET', 'ADMIN'),
